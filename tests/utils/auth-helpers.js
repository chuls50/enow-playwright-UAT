 ...
 * @param {string} role - The role name (admin, provider, patient, coordinator)
 ...
 * Usage: const { admin, patient } = await createMultiRoleContexts(browser, [ROLES.ADMIN, ROLES.PATIENT])
 * @param {Browser} browser - Playwright browser instance
