...
export class NotificationsPage extends BasePage {
    constructor(page) {
        ...
        this.sessionRemindersDefaultOption = page.getByTestId('custom-select-item-wrapper').locator('div').filter({ hasText: 'minutes before' });
    ...
    async gotoNotificationsPage() {
        await this.page.goto(`${process.env.PROD_URL}/account-settings/notifications`);
    ...
    async openSessionReminders() {
        ...
        await this.changeSessionReminder.waitFor({ state: 'visible', timeout: 10000 });
        await this.changeSessionReminder.click();
        // await this.sessionRemindersModal.waitFor({ state: 'visible' });
    }
}
