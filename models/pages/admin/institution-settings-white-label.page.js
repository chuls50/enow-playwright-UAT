...
export class InstitutionSettingsWhiteLabelPage extends BasePage {
    constructor(page) {
        ...
        this.organizationLogoAvatar = page.locator('div').filter({ hasText: /^Upload logo$/ }).getByTestId('avatar').locator('div').nth(1);
        ...
        this.faviconAvatar = page.locator('div').filter({ hasText: /^Upload favicon$/ }).getByTestId('avatar').locator('div').nth(1);
