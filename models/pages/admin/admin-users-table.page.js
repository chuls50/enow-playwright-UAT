...
export class UsersTablePage extends BasePage {
    constructor(page) {
        ...
        this.inviteUsersInstitutionDropdownOptionGlobalMed = page.getByTestId('custom-dropdown-item-GM Healthcare Prod').getByText('GM Healthcare Prod');
        ...
        this.invalidEmailFormatError = page.getByText('Email fields can only include alphanumeric characters, or at sign \'@\', period \'.\', blank \' \', hyphen \'-\', underscore \'_\'');
    ...
    async gotoUsersTable() {
        await this.page.goto(`${process.env.PROD_URL}/users-table`);
