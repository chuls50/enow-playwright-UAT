...
export class InstitutionSettingsInsurancePage extends BasePage {
    constructor(page) {
        ...
        this.premiumPackageToggle = page.locator('label').filter({ hasText: /^Premium package$/ }).getByTestId('switch-div');
        ...
        this.deleteButton = page.locator('div').filter({ hasText: /^Aetna20Delete$/ }).getByRole('button');
        ...
        this.selectPaymentProcessorDropdown = page.locator('div').filter({ hasText: /^Select a payment processor/ }).getByTestId('dropdown-field');
    ...
    async addInsuranceEntry(name = 'Test Insurance', copay = '20') {
        ...
        await this.page.waitForSelector(`div:has-text("${name}${copay}Delete")`, { state: 'visible' });
    }
