...
export class AccountCreationPage extends BasePage {
  constructor(page) {
    ...
    this.passwordUppercaseError = page.locator('div').filter({ hasText: /^At least 1 uppercase$/ }).getByTestId('icon');
    this.passwordLowercaseError = page.locator('div').filter({ hasText: /^At least 1 lowercase$/ }).getByTestId('icon');
    this.passwordNumberError = page.locator('div').filter({ hasText: /^At least 1 number$/ }).getByTestId('icon');
    this.passwordSpecialCharError = page.locator('div').filter({ hasText: /^At least 1 special character$/ }).getByTestId('icon');
  }
